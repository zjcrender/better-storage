...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! ./storage */ "./src/storage.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, storage_1) {
    "use strict";
    function __export(m) {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! ./utils */ "./src/utils.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, utils_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var defaultOptions = {
        expires: 0,
    ...
    var BetterStorage = /** @class */ (function () {
        function BetterStorage(options) {
            var _a = __assign(__assign({}, defaultOptions), options), storage = _a.storage, prefix = _a.prefix, expires = _a.expires, _b = _a.secret, secret = _b === void 0 ? false : _b, AES = _a.AES;
            utils_1.setSecret(AES.secret, AES.iv);
            this.secret = secret;
            this.stg = storage;
            this.prefix = prefix;
        ...
        BetterStorage.prototype.stgKey = function (key) {
            return "@" + this.prefix + "/" + key;
        };
        BetterStorage.prototype.set = function (key, value, options) {
            var _a = (options || {}), _b = _a.secret, secret = _b === void 0 ? this.secret : _b, _c = _a.expires, expires = _c === void 0 ? this.expires : _c;
            expires > 0 && (expires += Date.now());
            var valueStr = JSON.stringify(value);
            var value2Save = secret ? utils_1.encrypt(valueStr) : value;
            var signature = utils_1.sign(value2Save + expires);
            var data = {
                secret: secret,
                expires: expires,
                signature: signature,
        ...
        BetterStorage.prototype.remove = function (key) {
            this.stg.removeItem(this.stgKey(key));
        };
        BetterStorage.prototype.get = function (key) {
            this.checkReadable();
            var item = JSON.parse(this.stg.getItem(this.stgKey(key)));
            if (item === null)
                return null;
            var expires = item.expires, secret = item.secret, signature = item.signature, value = item.value;
            // 校验签名与是否过期
            if ((expires !== 0 && Date.now() > expires) ||
                utils_1.sign(value + expires) !== signature) {
                this.remove(key);
                return null;
            }
            return secret ? JSON.parse(utils_1.decrypt(value)) : value;
        };
        Object.defineProperty(BetterStorage.prototype, "keys", {
            get: function () {
                var keys = [];
                var regexp = new RegExp("^@" + this.prefix + "/");
                for (var i = 0, len = this.stg.length; i < len; i++) {
                    var key = this.stg.key(i);
                    if (regexp.test(key)) {
        ...
        BetterStorage.prototype.clear = function () {
            this.keys.forEach(this.remove, this);
        };
        Object.defineProperty(BetterStorage.prototype, "length", {
            get: function () {
        ...
        BetterStorage.prototype.checkReadable = function () {
            if (this.lockGet) {
                throw new Error('this storage is unreadable for now!');
            }
        };
        BetterStorage.prototype.readable = function () {
            this.lockGet = false;
        };
        BetterStorage.prototype.unreadable = function () {
            this.lockGet = true;
        };
        return BetterStorage;
    }());
    exports.BetterStorage = BetterStorage;
}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! ../cryptoJS/aes */ "./cryptoJS/aes.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, aes_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var SECRET_KEY = parseStr('30D17839695CB24C');
    var IV = parseStr('8BCAB84D2148034C');
    function parseStr(str) {
        return aes_1.default.enc.Utf8.parse(str);
    }
    function setSecret(key, iv) {
        SECRET_KEY = parseStr(key);
        IV = parseStr(iv);
    }
    exports.setSecret = setSecret;
    function encrypt(message) {
        return aes_1.default.AES.encrypt(message, SECRET_KEY, {
            iv: IV,
            mode: aes_1.default.mode.CBC,
            padding: aes_1.default.pad.Pkcs7
        }).toString();
    }
    exports.encrypt = encrypt;
    function decrypt(secret) {
        return aes_1.default.enc.Utf8.stringify(aes_1.default.AES.decrypt(secret, SECRET_KEY, {
            iv: IV,
            mode: aes_1.default.mode.CBC,
            padding: aes_1.default.pad.Pkcs7
        }));
    ...
    function sign(data) {
        return aes_1.default.HmacSHA1(data, SECRET_KEY).toString().toUpperCase();
    }
    exports.sign = sign;
}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
